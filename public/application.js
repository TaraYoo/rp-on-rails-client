...
var welcomeCardsTemplate = __webpack_require__(136);
var store = __webpack_require__(22);
var bokbulbokCardsTemplate = __webpack_require__(369);

var emptyDynamic = function emptyDynamic() {
  $('form').trigger('reset');
  $('.forms-to-show').empty();
  $('.bokbulbok').empty();
};

var getLocationsSuccess = function getLocationsSuccess(responseData) {
  store.user.locations = responseData.locations;
  emptyDynamic();

  var name = store.user.email.split('@')[0];
  var locations = store.user.locations;

  var locationCardsHtml = welcomeCardsTemplate({
    name: name,
    locations: locations
  });
  $('.welcome-cards').empty();
...
var getBokbulboksSuccess = function getBokbulboksSuccess(responseData) {
  store.user.bokbulboks = responseData.bokbulboks;
  emptyDynamic();

  var bokbulbokCardsHtml = bokbulbokCardsTemplate({
...
module.exports = {
  emptyDynamic: emptyDynamic,
  getLocationsSuccess: getLocationsSuccess,
  getBokbulboksSuccess: getBokbulboksSuccess
};
...
var edgeStatuses = {
  400: function _() {
    failureMessage('Please modify your url and try again');
  },
  401: function _() {
    failureMessage('This is unauthorized.');
  },
  403: function _() {
    failureMessage('You don\'t have access to this part.');
  },
  404: function _() {
    failureMessage('This item does not exist. Please try different one');
  },
  405: function _() {
    failureMessage('You don\'t have access to this command.');
  },
  406: function _() {
    failureMessage('Please request only JSON data.');
  },
  412: function _() {
    failureMessage('Please check your requirements.');
  },
  415: function _() {
    failureMessage('This file type isn\'t supported.');
  },
  500: function _() {
    failureMessage('There is an issue with the server. Please try again');
  },
  501: function _() {
    failureMessage('This function does not exist yet.');
  }
};
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://rponrails.herokuapp.com/',
...
var store = __webpack_require__(22);
var failures = __webpack_require__(71);

var getBokbulboks = function getBokbulboks() {
  return $.ajax({
...
var addBokbulbok = function addBokbulbok(formData) {
  return $.ajax({
    url: config.apiUrl + '/bokbulboks',
    method: 'POST',
    headers: {
...
var getABokbulBok = function getABokbulBok(id) {
  return $.ajax({
...
var deleteBokbulbok = function deleteBokbulbok(id) {
  return $.ajax({
    url: config.apiUrl + '/bokbulboks/' + id,
    method: 'DELETE',
    headers: {
...
var updateBokbulbok = function updateBokbulbok(id) {
  return $.ajax({
    url: config.apiUrl + '/bokbulboks/' + id,
    method: 'PATCH',
    headers: {
    ...
    statusCode: Object.assign(failures.edgeStatuses, {
      400: function _() {
        failures.failureMessage('This risk or reward did not get logged as used. I\'m sorry about the inconvenience.');
      }
    })
  });
};

var randomBokbulbok = function randomBokbulbok() {
  return $.ajax({
...
module.exports = {
  getBokbulboks: getBokbulboks,
  getABokbulBok: getABokbulBok,
  addBokbulbok: addBokbulbok,
  deleteBokbulbok: deleteBokbulbok,
  updateBokbulbok: updateBokbulbok,
  randomBokbulbok: randomBokbulbok
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"col s12 l6\">\n    <div class=\"card hoverable blue-grey darken-1\">\n      <div class=\"card-content white-text\">\n        <span class=\"card-title\">"
    ...
    + "</span>\n        <p class=\"truncate\">Plot: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.plot : stack1), depth0))
    + "</p>\n        <p>Outcome: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.outcome : stack1), depth0))
    + "</p>\n        <p>Players visited? "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.visited : stack1), depth0))
    + "</p>\n        <p>Are players here? "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.has_players : stack1), depth0))
    + "</p>\n      </div>\n      <div class=\"card-action\">\n        <a class=\"get-details\" id=\"location-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n          Click here to see location details, update location, or delete\n        </a>\n      </div>\n    </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "<h2 class=\"header center grey-text\">Welcome "
    ...
    + "</h2>\n\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.locations : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var signIn = function signIn(formData) {
  return $.ajax({
    ...
    statusCode: Object.assign(failures.edgeStatuses, {
      401: function _() {
        failures.failureMessage('Please check your email or password and try again.');
      }
    })
  });
};
...
var changePassword = function changePassword(formData) {
  return $.ajax({
    ...
    statusCode: Object.assign(failures.edgeStatuses, {
      400: function _() {
        failures.failureMessage('Please check your password and try again.');
      }
    })
  });
};
...
var demoSignOut = function demoSignOut() {
  return $.ajax({
...
var addLocation = function addLocation(formData) {
  return $.ajax({
...
var getLocations = function getLocations(responseData) {
  return $.ajax({
    url: config.apiUrl + '/locations',
    method: 'GET',
    headers: {
...
var getALocation = function getALocation(id) {
  return $.ajax({
...
var updateLocation = function updateLocation(id, formData) {
  return $.ajax({
    url: config.apiUrl + '/locations/' + id,
    method: 'PATCH',
    headers: {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10), __webpack_require__(10), __webpack_require__(10), __webpack_require__(55)))
...
var locationEvents = __webpack_require__(374);
var bokbulbokEvents = __webpack_require__(378);
...
var commonUi = __webpack_require__(50);
var store = __webpack_require__(22);
var failures = __webpack_require__(71);

var onSignUpRequested = function onSignUpRequested(event) {
  event.preventDefault();
  ui.signUpRequested();
};

var onSignInRequested = function onSignInRequested(event) {
  event.preventDefault();
  ui.signInRequested();
};
...
var changePasswordRequested = function changePasswordRequested(event) {
  event.preventDefault();
...
var onChangePassword = function onChangePassword(event) {
  ...
  if (store.user.email === 'demo@demo.com') {
    ...
    api.changePassword(formData).then(ui.changePasswordSuccess).catch(commonUi.emptyDynamic);
  }
};
...
var onSignOut = function onSignOut(event) {
  ...
  if (store.user.email === 'demo@demo.com') {
    api.demoSignOut().then(ui.demoSignOut).catch(commonUi.emptyDynamic);
  } else {
    api.signOut().then(ui.signOutSuccess).catch(commonUi.emptyDynamic);
  }
};
...
var commonUi = __webpack_require__(50);
var store = __webpack_require__(22);
var signUpForm = __webpack_require__(370);
var signInForm = __webpack_require__(371);
var welcomeTemplate = __webpack_require__(136);
var authorizedOptions = __webpack_require__(372);
var changePasswordForm = __webpack_require__(373);
var api = __webpack_require__(138);

var signUpRequested = function signUpRequested() {
  commonUi.emptyDynamic();

  var signUpFormHtml = signUpForm();

  $('.requested-form').empty();
  $('.requested-form').append(signUpFormHtml);
};

var signInRequested = function signInRequested() {
  commonUi.emptyDynamic();

  var signUpFormHtml = signInForm();
...
var signInSuccess = function signInSuccess(responseData) {
  ...
  var name = store.user.email.split('@')[0];
  var locations = store.user.locations;
  var bokbulboks = store.user.bokbulboks;

  // get the post sign in template
  var welcomeHtml = welcomeTemplate({ name: name,
    locations: locations,
    bokbulboks: bokbulboks });

  var authorizedOptionHtml = authorizedOptions();
...
var signUpFailure = function signUpFailure(responseData) {
  ...
  var header = Object.keys(response)[0];
  var details = response['' + Object.keys(response)[0]][0];
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"col s12 m4\">\n    <div class=\"card-panel "
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.used : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\" id=\"bokbulbok-card-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    ...
    + "</p>\n        <p>Used? "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.used : stack1), depth0))
    + "</p>\n      </div>\n      <div class=\"card-tabs\">\n        <ul class=\"tabs tabs-fixed-width\">\n          <li class=\"tab delete-bokbulbok red darken-4\"><a id=\"delete-bokbulbok-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</a></li>\n        </ul>\n      </div>\n    </div>\n  </div>\n\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.bokbulboks : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<p class=\"landing-alerts\"></p>\n<form class=\"col s12\" id=\"sign-up-form\">\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input name=\"credentials[email]\" type=\"email\" id=\"sign-up-email\" class=\"validate\" placeholder=\"Email\">\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"password\" id=\"sign-up-password\" class=\"validate\" name=\"credentials[password]\" placeholder=\"Pasword\">\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"password\" id=\"password-confirmation\" class=\"validate\" name=\"credentials[password_confirmation]\" placeholder=\"Password Confirmation\">\n    </div>\n  </div>\n  <button class=\"btn waves-effect waves-light\" type=\"submit\" name=\"action\" id=\"sign-up-button\">Sign Up\n    <i class=\"material-icons right\">send</i></button>\n</form>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form class=\"col s12\" id=\"sign-in-form\">\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"email\" id=\"sign-in-email\" class=\"validate\" name=\"credentials[email]\" placeholder=\"Email\">\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"password\" id=\"sign-in-password\" class=\"validate\" name=\"credentials[password]\" placeholder=\"Pasword\">\n    </div>\n  </div>\n  <button class=\"btn waves-effect waves-light\" type=\"submit\" name=\"action\">Sign In\n  <i class=\"material-icons right\">send</i></button>\n</form>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "  <li><a id=\"change-password-btn\">change password</a></li>\n  <li><a id=\"sign-out-button\">sign out</a></li>\n  <li><a id=\"add-location-button\">add location</a></li>\n  <li><a id=\"get-bokbulboks-button\">See risks and rewards</a></li>\n  <li><a id=\"add-bokbulbok-button\">Add risks or rewards</a></li>\n  <li><a id=\"get-locations-button\">Get all locations</a></li>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form class=\"col s12 container\" id=\"change-password-form\">\n  <p class=\"user-alert\"></p>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"password\" id=\"old-password\" class=\"validate\" name=\"passwords[old]\" placeholder=\"Old Password\">\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"password\" id=\"new-pasword\" class=\"validate\" name=\"passwords[new]\" placeholder=\"New Password\">\n    </div>\n  </div>\n  <button class=\"btn waves-effect waves-light\" type=\"submit\" name=\"action\">Submit\n    <i class=\"material-icons right\">send</i></button>\n    <button class=\"btn waves-effect waves-light cancel-btn\" name=\"action\">Cancel\n      <i class=\"material-icons right\">cancel</i>\n    </button>\n</form>\n";
},"useData":true});
...
var onAddLocationPressed = function onAddLocationPressed(event) {
  event.preventDefault();
...
var onAddLocation = function onAddLocation(event) {
  ...
  api.addLocation(formData).then(ui.addLocationSuccess).catch(commonUi.emptyDynamic);
};

var onGetALocation = function onGetALocation(event) {
  event.preventDefault();

  var targeted = event.target.id;
  var targetNum = parseInt(targeted.split('-')[1]);

  api.getALocation(targetNum).then(ui.gotALocationSuccess);
};

var getAllLocations = function getAllLocations(event) {
  event.preventDefault();

  api.getLocations(store).then(commonUi.getLocationsSuccess);
};
...
var onDeleteLocation = function onDeleteLocation(event) {
  ...
  api.deleteLocation(targetNum).then(ui.deleteLocationSuccess);
};
...
var onUpdateLocation = function onUpdateLocation(event) {
  ...
  var form = event.target;
  var formData = getFormFields(form);
  var apiData = { location: {} };

  var targeted = event.target.id;
  var targetNum = parseInt(targeted.split('-')[3]);

  for (var key in formData.location) {
    if (formData.location[key] !== '') {
      apiData.location[key] = formData.location[key];
    }
  }

  api.updateLocation(targetNum, apiData).then(ui.updateLocationSuccess);
};
...
var api = __webpack_require__(139);
var store = __webpack_require__(22);
var singleLocationTemplate = __webpack_require__(376);
var addLocationTemplate = __webpack_require__(377);

var addLocationPressed = function addLocationPressed() {
  // empty all dynamic content
  commonUi.emptyDynamic();

  // show the add-location-form
  var addLocationHtml = addLocationTemplate();
  $('.authorized-form').empty();
  $('.authorized-form').append(addLocationHtml);
};

var addLocationSuccess = function addLocationSuccess(responseData) {
  // empty all dynamic content
  commonUi.emptyDynamic();
  ...
  api.getLocations(store).then(commonUi.getLocationsSuccess).catch(commonUi.failureMessage);
};

var gotALocationSuccess = function gotALocationSuccess(responseData) {
  // empty all dynamic content
  commonUi.emptyDynamic();

  // show the single location
  var singleLocationHtml = singleLocationTemplate({ location: responseData.location });
  $('.welcome-cards').empty();
  $('.welcome-cards').append(singleLocationHtml);
};

var deleteLocationSuccess = function deleteLocationSuccess() {
  // empty all dynamic content
  commonUi.emptyDynamic();
...
var updateLocationSuccess = function updateLocationSuccess(responseData) {
  // empty all dynamic content
  commonUi.emptyDynamic();
...
module.exports = {
  ...
  gotALocationSuccess: gotALocationSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"row\">\n  <div class=\"col s12 m6\" id=\"only-location-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n    <h4>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.id : stack1), depth0))
    + ": "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n    <h5>Plot</h5>\n    <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.plot : stack1), depth0))
    + "</p>\n    <h5>Outcomes</h5>\n    <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.outcome : stack1), depth0))
    + "</p>\n    <h5>Player interaction</h5>\n    <p>Have players visited? "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.visited : stack1), depth0))
    + "</p>\n    <p>Are players here? "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.has_players : stack1), depth0))
    + "</p>\n  </div>\n\n  <div class=\"col s12 m6\">\n    <form class=\"col s12 container update-location-form\" id=\"update-location-form-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n      <h4>Update "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n      <p class=\"update-location-alert\"></p>\n      <div class=\"row\">\n        <div class=\"input-field col s12\">\n          <input type=\"text\" class=\"validate\" name=\"location[plot]\">\n          <label for=\"plot\">New Plot</label>\n        </div>\n        <div class=\"input-field col s12\">\n          <input type=\"text\" class=\"validate\" name=\"location[outcome]\">\n          <label for=\"outcome\">New Outcome</label>\n        </div>\n        <div class=\"input-field col s6\">\n          <input type=\"text\" class=\"validate\" name=\"location[visited]\">\n          <label for=\"visited\">Did players come here?</label>\n        </div>\n        <div class=\"input-field col s6\">\n          <input type=\"text\" class=\"validate\" name=\"location[has_players]\">\n          <label for=\"has_players\">Are players here?</label>\n        </div>\n      </div>\n      <button class=\"btn waves-effect waves-light\" type=\"submit\">Submit\n        <i class=\"material-icons right\">send</i></button>\n    </form>\n  </div>\n</div>\n\n<div class=\"row\">\n  <ul>\n    <li><a id=\"delete-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.location : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" class=\"delete-location\">Delete Location</a></li>\n  </ul>\n  <ul>\n    <li><a id=\"get-profile\">Go back to locations list</a></li>\n  </ul>\n  <ul>\n    <li><a id=\"get-bokbulbok\">Generate a risk or reward</a></li>\n  </ul>\n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form class=\"col s12 container\" id=\"create-location-form\">\n  <p class=\"create-location-alert\"></p>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"text\" id=\"name\" class=\"validate\" name=\"location[name]\" placeholder=\"Location Name\">\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"text\" id=\"plot\" class=\"validate\" name=\"location[plot]\" placeholder=\"Location Plot\">\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"text\" id=\"outcome\" class=\"validate\" name=\"location[outcome]\" placeholder=\"Location Outcome\">\n    </div>\n  </div>\n  <button class=\"btn waves-effect waves-light\" type=\"submit\" name=\"action\">Submit\n    <i class=\"material-icons right\">send</i>\n  </button>\n  <button class=\"btn waves-effect waves-light cancel-btn\" name=\"action\">Cancel\n    <i class=\"material-icons right\">cancel</i>\n  </button>\n</form>\n";
},"useData":true});
...
var onGetBokbulboks = function onGetBokbulboks(event) {
  event.preventDefault();

  api.getBokbulboks(store).then(commonUi.getBokbulboksSuccess);
};

var onAddBokbulbokPressed = function onAddBokbulbokPressed(event) {
  event.preventDefault();

  ui.addBokbulbokPressed();
};

var onAddBokbulbok = function onAddBokbulbok(event) {
  event.preventDefault();

  var form = event.target;
  var formData = getFormFields(form);

  api.addBokbulbok(formData).then(ui.addBokbulbokSuccess).catch(commonUi.emptyDynamic);
};

var getRandomBokbulbok = function getRandomBokbulbok(event) {
  event.preventDefault();
  api.randomBokbulbok().then(ui.getRandomBokbulbokSuccess);
};

var onDeleteBokbulbok = function onDeleteBokbulbok(event) {
  event.preventDefault();

  var targetId = event.target.id.split('-')[2];
  api.deleteBokbulbok(targetId).then(ui.deleteBokbulbokSuccess);
};

var cancelForms = function cancelForms(event) {
  event.preventDefault();
...
var commonUi = __webpack_require__(50);
var addBokbulbokTemplate = __webpack_require__(380);
var randomBokbulbokTemplate = __webpack_require__(381);
var api = __webpack_require__(100);
var updateStores = __webpack_require__(382);

var getRandomBokbulbokSuccess = function getRandomBokbulbokSuccess(responseData) {
  // empty all dynamic content
  commonUi.emptyDynamic();

  var randomBokbulbokHtml = randomBokbulbokTemplate({ bokbulbok: responseData.bokbulbok });

  $('.bokbulbok').empty();
  $('.bokbulbok').append(randomBokbulbokHtml);

  var bokbulbokId = responseData.bokbulbok.id;
  api.updateBokbulbok(bokbulbokId).then(updateStores.updateUserBokbulbok);
};

var getBokbulboksFailure = function getBokbulboksFailure(responseData) {
  $('.bokbulbok-alerts').text('something went wrong');
};

var addBokbulbokPressed = function addBokbulbokPressed() {
  // empty all dynamic content
  commonUi.emptyDynamic();

  // show the add-risks-or-rewards-form
  var addBokbulbokHtml = addBokbulbokTemplate();
  $('.authorized-form').empty();
  $('.authorized-form').append(addBokbulbokHtml);
};

var addBokbulbokSuccess = function addBokbulbokSuccess(responseData) {
  // empty all dynamic content
  commonUi.emptyDynamic();
  ...
  // make a second api request and store to user
  api.getBokbulboks().then(commonUi.storeBokbulboks);
};

var deleteBokbulbokSuccess = function deleteBokbulbokSuccess() {
  // empty all dynamic content
  commonUi.emptyDynamic();
  ...
  api.getBokbulboks().then(commonUi.getBokbulboksSuccess);
};

module.exports = {
  getBokbulboksFailure: getBokbulboksFailure,
  getRandomBokbulbokSuccess: getRandomBokbulbokSuccess,
  addBokbulbokPressed: addBokbulbokPressed,
  addBokbulbokSuccess: addBokbulbokSuccess,
  deleteBokbulbokSuccess: deleteBokbulbokSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10)))
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form class=\"col s12 container\" id=\"create-bokbulbok-form\">\n  <h4>Add a risk or reward</h4>\n  <div class=\"row\">\n    <div class=\"input-field col s12\">\n      <input type=\"text\" id=\"description\" class=\"validate\" name=\"bokbulbok[description]\" placeholder=\"description\">\n    </div>\n  </div>\n  <button class=\"btn waves-effect waves-light\" type=\"submit\" name=\"action\">Submit\n    <i class=\"material-icons right\">send</i>\n  </button>\n  <button class=\"btn waves-effect waves-light cancel-btn\" name=\"action\">Cancel\n    <i class=\"material-icons right\">cancel</i>\n  </button>\n  </form>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"col s12 m4\" id=\"bokbulbok-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bokbulbok : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n  <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.bokbulbok : depth0)) != null ? stack1.description : stack1), depth0))
    + "</p>\n</div>\n";
},"useData":true});
...
var bokbulbokApi = __webpack_require__(100);
var subStorage = __webpack_require__(383);
var store = __webpack_require__(22);

var updateUserBokbulbok = function updateUserBokbulbok() {
  bokbulbokApi.getBokbulboks().then(subStorage.storeBokbulboks);
};

module.exports = {
  updateUserBokbulbok: updateUserBokbulbok
};
...
var storeBokbulboks = function storeBokbulboks(responseData) {
  store.user.bokbulboks = responseData.bokbulboks;
};

module.exports = {
  storeBokbulboks: storeBokbulboks
};
